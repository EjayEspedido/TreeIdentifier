...
export async function registerRoutes(
  ...
  if (!hasData) {
    ...
    await storage.createTree({
      ...
      imageUrl: "https://forestry.com/wp/wp-content/uploads/2024/10/124.webp",
      minAreaSqm: 12,
      floodResilient: true,
      urbanSuitable: true,
    ...
    await storage.createTree({
      ...
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/6/6b/Starr-090617-0840-Pterocarpus_indicus-yellow_flowering_tree-Ulumalu_Haiku-Maui_%2824842758332%29.jpg",
      minAreaSqm: 25,
      floodResilient: true,
      urbanSuitable: false,
    ...
    await storage.createTree({
      ...
      imageUrl: "https://nurserynisarga.in/wp-content/uploads/2019/09/cassia-fistula.webp",
      minAreaSqm: 10,
    ...
    await storage.createTree({
      ...
      imageUrl: "https://forestry.com/wp/wp-content/uploads/2024/11/117.webp",
      minAreaSqm: 20,
      floodResilient: true,
      urbanSuitable: false,
      growthTimeline: commonTimeline
    ...
    await storage.createTree({
      ...
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/f/f8/Bischofia_javanica.jpg",
      minAreaSqm: 18,
      floodResilient: true,
      urbanSuitable: true,
      growthTimeline: commonTimeline
    ...
    await storage.createTree({
      ...
      imageUrl: "https://sylviatramos.blog/wp-content/uploads/2012/12/p1060544.jpg",
      minAreaSqm: 10,
      floodResilient: false,
      urbanSuitable: true,
      growthTimeline: commonTimeline
    ...
    await storage.createTree({
      ...
      imageUrl: "https://forestry.com/wp/wp-content/uploads/2023/12/5-4.webp",
      minAreaSqm: 20,
      floodResilient: true,
      urbanSuitable: true,
      growthTimeline: commonTimeline
    ...
    await storage.createTree({
      ...
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/c/c2/Wallaceodendron_celebicum_3zz.jpg",
      minAreaSqm: 25,
      floodResilient: true,
      urbanSuitable: true,
      growthTimeline: commonTimeline
